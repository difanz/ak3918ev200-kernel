/*
 * plat-anyka/ak_sensor.h — ISP-era sensor framework (recovered)
 *
 * Not present in Anyka 1.0.05. Required by:
 *   drivers/media/video/plat-anyka/ak_sensor.c
 ...
 *
 * Install as: include/plat-anyka/ak_sensor.h
 *
 * Provenance: notes/ANSWER_20260802_sensor.md (stock kallsyms + call sites)
 */
