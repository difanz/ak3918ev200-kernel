...
typedef enum {
    CAMERA_WMODE_PREV = 0,    //preview mode
    CAMERA_WMODE_CAP,        // capture mode
    CAMERA_WMODE_REC        // record mode
} T_CAMERA_WORKMODE;

typedef enum {
    PIN_AVDD = 0,    //get AVDD GPIO value
    PIN_POWER,        //get POWER GPIO value
    PIN_RESET        //get RESET GPIO value
} T_CAMERA_PINTYPE;
