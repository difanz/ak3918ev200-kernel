...
struct ak_codec_ops {
	...
	unsigned long (*set_dac_samplerate)(struct ak_codec_dai *dai, unsigned int rate);
	...
	/* The power amplifier gate alone, with no codec or route side effects. */
	void (*speaker_enable)(struct ak_codec_dai *dai, bool on);
