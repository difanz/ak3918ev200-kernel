...
/*
 * Banks that can raise an interrupt.  IRQ_GPIO_0 + 2 * 32 is already NR_IRQS,
 * so anything beyond this is not addressable as an IRQ.
 */
#define AK_GPIO_IRQ_BANKS		2
...
/*
 * How one share-pin field is driven back to "this pad is a GPIO".
 *
