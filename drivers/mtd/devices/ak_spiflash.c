...
static struct flash_info __devinitdata ak_spiflash_supportlist [] = {
	...
	/*
	 * SPI NOR ids backported from u-boot's drivers/mtd/spi/spi-nor-ids.c.
	 *
	 ...
	 *    u-boot indicates quad support, because such parts have a second
	 ...
	 *
	 * The chip actually fitted to this camera, xm25qh64c, keeps its own
	 * entry above.
	 */
 ...
 *
 * Layout, verified against this camera's flash dump and against what U-Boot
 * does to find the same table:
 *
 ...
 *
 * Nothing here is specific to this camera: no offset, size or name is
