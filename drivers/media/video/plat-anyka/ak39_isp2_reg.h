...
#define     CH3_UV_MODE				12
#define     VIDEO_MODE              13
#define     SD_BUF_MODE             14
#define     POWER_SAVE_EN           15
#define     DUAL_SENSOR_SEL			17
...
#define		CH3_FRAME_BUF_ID		18//lz 7.19
#define		MIPI_ERROR_ECC			17//lz7.19
#define		MIPI_ERROR_CRC			16//lz7.19
#define		REG_DMA_DONE			15//lz7.19
#define		ISP_UNDER_WORKING		14//lz7.19
...
/*
 * The frame-buffer address enables are NOT in TNTERRUPT on this part - they
 * live in GEN_CTRL, and they count up rather than down.
 *
 * EV300 needed twelve enables for three output channels, which did not fit
 * alongside GEN_CTRL's other fields, so Anyka moved them into the spare top
 * half of TNTERRUPT and reused GEN_CTRL 15 and 17 for POWER_SAVE_EN and
 * DUAL_SENSOR_SEL. EV200 needs only eight and kept them where they were - so
 * on this part those two EV300 names are MAIN_ADDR1_EN and MAIN_ADDR3_EN.
 *
 * Because the order is also reversed, low_4bits_revert() must NOT be applied
 * to the buffer-id nibble here. Every site is listed in notes/isp-port.md.
 *
 * Recovered from this unit's stock kernel.
 */
#define     ISP_ADDR_EN_ADDR        GEN_CTRL_ADDR
#define     ISP_ADDR_EN_SHIFT       15
...
#else
#define     ISP_ADDR_EN_ADDR        TNTERRUPT_ADDR
#define     ISP_ADDR_EN_SHIFT       28
#define     MAIN_ADDR1_EN           31//lz7.19
#define     MAIN_ADDR2_EN           30
#define     MAIN_ADDR3_EN           29
#define     MAIN_ADDR4_EN           28
#define     SUB_ADDR1_EN            27
#define     SUB_ADDR2_EN            26
#define     SUB_ADDR3_EN            25
#define     SUB_ADDR4_EN            24
#define     CH3_ADDR1_EN            23
#define     CH3_ADDR2_EN            22
#define     CH3_ADDR3_EN            21
#define     CH3_ADDR4_EN            20
#endif
#define		DUAL_SENSOR_REG_DONE_EN 19
#define		DUAL_SENSOR_FRAME_DONE_EN 18
#define		MIPI_ERROR_ECC_EN       17
#define		MIPI_ERROR_CRC_EN       16
#define		REG_DMA_DONE_EN 		15
#define		ISP_UNDER_WORK_EN 		14
...
#define		MIPI_LINE_END_SEL		31//lz7.19
#define		MIPI_LINE_END_CNT_EN	30
#define		MIPI_COUNT_TIME			24//lz8.29
#define		DUAL_SENSOR_REG_DONE	4
#define		DUAL_SENSOR_FRAME_DONE	3
...
//      ADDR_REG_36      
#define   TNR_VSIZE               0
#define	  DUAL_SENSOR_HDR_STATE	  30

//      ADDR_REG_37
#define	  DUAL_SENSOR_PARA_BADDR  0
#define	  DUAL_SENSOR_3DNR_STATE  30
...
#define		TNR_HEIGHT_BLOCK_SIZE  24//lz7.19
#define		TNR_HEIGHT_BLOCK_NUM   31//lz7.19
...
//      PP_REG_2    
#define     PP_MASK1_S_YPOS         0
#define     PP_MASK1_E_YPOS         11
#define		PP_MASK1_EN				31

//      PP_REG_3  
#define     PP_MASK2_S_XPOS         0
#define     PP_MASK2_E_XPOS         11
//      PP_REG_4              
#define     PP_MASK2_S_YPOS         0
#define     PP_MASK2_E_YPOS         11
#define		PP_MASK2_EN				31

//      PP_REG_5   
#define     PP_MASK3_S_XPOS         0
#define     PP_MASK3_E_XPOS         11
//      PP_REG_6 
#define     PP_MASK3_S_YPOS         0//lz8.30
#define     PP_MASK3_E_YPOS         11
#define		PP_MASK3_EN				31
...
//      PP_REG_8  
#define     PP_MASK4_S_YPOS         0       
#define     PP_MASK4_E_YPOS         11
#define		PP_MASK4_EN				31

//      PP_REG_9  
#define     PP_MASK5_S_XPOS         0
#define     PP_MASK5_E_XPOS         11
//      PP_REG_10               
#define     PP_MASK5_S_YPOS         0
#define     PP_MASK5_E_YPOS         11
#define		PP_MASK5_EN				31

//      PP_REG_11        
#define     PP_MASK6_S_XPOS         0           
#define     PP_MASK6_E_XPOS         11
//      PP_REG_12
#define     PP_MASK6_S_YPOS         0
#define     PP_MASK6_E_YPOS         11
#define		PP_MASK6_EN				31

//      PP_REG_13                  
#define     PP_MASK7_S_XPOS         0
#define     PP_MASK7_E_XPOS         11
//      PP_REG_14 
#define     PP_MASK7_S_YPOS         0      
#define     PP_MASK7_E_YPOS         11
#define		PP_MASK7_EN				31

//      PP_REG_15      
#define     PP_MASK8_S_XPOS         0
#define     PP_MASK8_E_XPOS         11
//      PP_REG_16       
#define     PP_MASK8_S_YPOS         0
#define     PP_MASK8_E_YPOS         11
...
//      PP_REG_30               
#define     PP_OSD1_ADDR1           0
#define     PP_OSD1_ENABLE1         31

//      PP_REG_31               
#define     PP_OSD1_START1_X         0
#define     PP_OSD1_START1_Y         13

//      PP_REG_32              
#define     PP_OSD1_END1_X           0
#define     PP_OSD1_END1_Y           13
#define     PP_OSD1_ALPHA1           28

//      PP_REG_33              
#define     PP_OSD1_ADDR2            0
#define     PP_OSD1_ENABLE2          31


//      PP_REG_34         
#define     PP_OSD1_START2_X         0
#define     PP_OSD1_START2_Y         13

//      PP_REG_35               
#define     PP_OSD1_END2_X           0
#define     PP_OSD1_END2_Y           13
#define     PP_OSD1_ALPHA2           28

//      PP_REG_36              
#define     PP_OSD1_ADDR3            0
#define     PP_OSD1_ENABLE3          31


//      PP_REG_37             
#define     PP_OSD1_START3_X         0
#define     PP_OSD1_START3_Y         13

//      PP_REG_38              
#define     PP_OSD1_END3_X           0
#define     PP_OSD1_END3_Y           13
#define     PP_OSD1_ALPHA3           28


//      PP_REG_39              
#define     PP_OSD2_ADDR1           0
#define     PP_OSD2_ENABLE1         31

//      PP_REG_40             
#define     PP_OSD2_START1_X         0
#define     PP_OSD2_START1_Y         13

//      PP_REG_41             
#define     PP_OSD2_END1_X           0
#define     PP_OSD2_END1_Y           13
#define     PP_OSD2_ALPHA1           28

//      PP_REG_42            
#define     PP_OSD2_ADDR2            0
#define     PP_OSD2_ENABLE2          31


//      PP_REG_43        
#define     PP_OSD2_START2_X         0
#define     PP_OSD2_START2_Y         13

//      PP_REG_44            
#define     PP_OSD2_END2_X           0
#define     PP_OSD2_END2_Y           13
#define     PP_OSD2_ALPHA2           28

//      PP_REG_45           
#define     PP_OSD2_ADDR3            0
#define     PP_OSD2_ENABLE3          31


//      PP_REG_46             
#define     PP_OSD2_START3_X         0
#define     PP_OSD2_START3_Y         13

//      PP_REG_47            
#define     PP_OSD2_END3_X           0
#define     PP_OSD2_END3_Y           13
#define     PP_OSD2_ALPHA3           28
...
/* The scale destination size is 12+12 here, 13+13 on EV300. The rate fields
 * above are 12+12 on both. */
#ifdef CONFIG_CPU_AK3918EV200
#define     PP_DST_BITS             12
#define     pp_DST1_HEIGHT          12
#define     pp_DST2_HEIGHT          12
#else
#define     PP_DST_BITS             13
#define     pp_DST1_HEIGHT          13
#define     pp_DST2_HEIGHT          13
#endif

//      PP_REG_52             
#define     PP_FRAME1_CTRL          0
#define     PP_FRAME2_CTRL          8
#define 	PP_FRAME3_CTRL			16
...
#ifdef CONFIG_CPU_AK3918EV200
/* EV300 leaves 22 and 23 undefined; EV200 puts the two OSD enables there
...
/*
 * Config-block word indices that moved between the two parts. EV200 has two
 * output channels where EV300 has three, so every word after a dropped
 * channel-3 word shifts down. Both builds place the blocks at byte-identical
 * offsets from isp->area, so an index maps 1:1 to a hardware register and
 * getting one wrong is an absolute error, not an offset error.
 *
 * Recovered from this unit's stock kernel; see notes/isp-port.md.
 */
#ifdef CONFIG_CPU_AK3918EV200
#define     R1_STAT_ADDR2           49      /* .. 51, then 52 reserved */
#define     R1_TNR_YADDR            53      /* .. 58 */
#define     R5_STAT_ADDR1           31
#define     R5_ENABLE               32
#define     R4_OSD_COLOR_TABLE      11      /* .. 22 */
#define     R4_MASK_COLOR           23
#define     R4_MAIN_OSD             24      /* .. 26, one region */
#define     R4_SUB_OSD              27      /* .. 29, one region */
#define     R4_MAIN_SCALE           30      /* rate, then dst */
#define     R4_SUB_SCALE            32
#define     R4_FRAME_CTRL           34
#else
#define     R1_STAT_ADDR2           58
#define     R1_TNR_YADDR            61
#define     R5_STAT_ADDR1           34
#define     R5_ENABLE               35
#define     R4_OSD_COLOR_TABLE      16
#define     R4_MASK_COLOR           28
#define     R4_MAIN_OSD             29      /* .. 37, three regions */
#define     R4_SUB_OSD              38      /* .. 46, three regions */
#define     R4_MAIN_SCALE           47
#define     R4_SUB_SCALE            49
#define     R4_FRAME_CTRL           51
#endif
