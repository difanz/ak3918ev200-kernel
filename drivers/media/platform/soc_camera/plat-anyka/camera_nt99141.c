...
static T_VOID cam_nt9914100_set_mirror(T_CAMERA_MIRROR mirror)
{
    switch(mirror)
    {
        case CAMERA_MIRROR_V:
            camera_setup(MIRROR_V_TAB);//vertical mirror
            break;
        case CAMERA_MIRROR_H:
            camera_setup(MIRROR_H_TAB);//horizontal mirror
            break;
        case CAMERA_MIRROR_NORMAL:
            camera_setup(MIRROR_NORMAL_TAB);//normal
            break;
        case CAMERA_MIRROR_FLIP:
            camera_setup(MIRROR_FLIP_TAB);//vertical+horizontal mirror
            break;
        default:
