...
enum ak_isp_wb_type {
    WB_OPS_TYPE_MANU=0,        //manual white balance
    WB_OPS_TYPE_AUTO,          //auto white balance
};

enum awb_stat_param_type
{
    STAT_NORMAL = 0,   //parameters under normal conditions,
    STAT_ABNORMAL= 1,  //parameters for when all five parameter sets are invalid,
};
